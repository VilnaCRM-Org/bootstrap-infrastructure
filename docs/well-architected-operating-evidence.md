...
| Guardrail health | Same-repo required checks pass and are not skipped. | Current hosted checks completed on 2026-05-09, including real test preview, destructive gate, cost proxy, IAM validation, Local Battery, mutation, security scans, and quality gates. | Maintainer | Per PR | Do not merge until hosted checks pass or admin records a temporary exception. |
