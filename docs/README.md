...
- [ci-guardrails.md](ci-guardrails.md): Static quality, DevSecOps guardrails, and deploy workflow layout.
- [testing.md](testing.md): Pulumi test matrix, local commands, and CI mapping.
