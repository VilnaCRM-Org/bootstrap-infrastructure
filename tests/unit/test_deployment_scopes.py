...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("scripts/reviewed_source_admission.py", False),
        ...
        (".github/workflows/pulumi-pr-guardrails.yml", False),
        (".github/workflows/reviewed-pr-preview.yml", False),
        (".github/workflows/reviewed-source-signal.yml", False),
