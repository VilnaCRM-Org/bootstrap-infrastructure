#!/usr/bin/env python3
"""Private PROD8 checkpoint reconciliation. No body output; no mutation retries.
...
KEY = ".pulumi/stacks/github-ci-bootstrap/prod.json"
VERSION = "tJ6HbWVZBsGpK.bPrNqW4p3YYfu8zh1Y"
ETAG = '"d59097a7d19a46e1d7dc8b8ca2aa28f9"'
SEED_BUCKET = "issue215-independent-seed-933245420672-prod"
SEED_KEY = "arn:aws:kms:eu-central-1:933245420672:key/2d42d715-1452-4766-8cfa-020b53288443"
...
def main():
    ...
    config = dict(inventory["accounts"]["prod"], environment="prod")
    ...
    recovery_key = "pr226/prod/checkpoint-bindings/" + uuid.uuid4().hex + ".json"
