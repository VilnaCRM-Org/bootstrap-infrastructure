#!/usr/bin/env python3
"""PROD eight reviewed boundary additions, once each; no retries or activation.
...
def main():
    ...
    print("Eight exact PROD boundaries installed/read back. Checkpoint reconciliation and disabled enrollment remain required.")
